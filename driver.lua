...
function ProxyHelper.GetNextMediaLib(seq)	
	...
	local msg_id = {'{"action":"action.request.getlocalMusic"}',
				    ...
				    '{"action":"action.response.sensorlist"}'}
...
g_browse_music = {
	...
	{type = "cboards", folder = "true", text = "榜单", subtext = "", URL = "", key = "boards",ImageUrl = gMediaPath .. "ico_tunein_trending.png"},
